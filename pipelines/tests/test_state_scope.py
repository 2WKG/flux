...
def test_minnesota_eaglei_ingests_from_full_name_source_value(tmp_path):
    ...
    try:
        ...
        con.execute("""INSERT INTO counties (county_fips,name,state,pop,geom_wkb,source_name,source_ref,source_version,source_retrieved_at,fixture_batch_id) VALUES ('27001','Aitkin','MN',1,?, 'test','test',NULL,NULL,'test')""", [bytes.fromhex("010300000000000000")])
