    ...
    *, lines_path: Path, substations_path: Path, retrieved_at: str
    ...
    source = {
        ...
        "content_sha256": hashlib.sha256(
            lines_path.read_bytes() + substations_path.read_bytes()
        ).hexdigest(),
    }
    ...
    for feature in substations:
        ...
        assets.append(
            {
                "asset_id": f"{SOURCE_ID}:substation:{oid}",
        ...
        "coverage": [
            {
                ...
                "denominator_count": len(lines),
                "unknown_count": None,
                "unavailable_count": None,
                "denominator_basis": "returned feature count for queried source layer",
            ...
            },
            {
                ...
                "denominator_count": len(substations),
                "unknown_count": None,
                "unavailable_count": None,
                "denominator_basis": "returned feature count for queried source layer",
