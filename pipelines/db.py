...
P0_HELPER_STATEMENTS = (
    ...
    """CREATE TABLE IF NOT EXISTS weather_source_runs (
        scenario_id TEXT NOT NULL, valid_ts TIMESTAMP NOT NULL,
        source TEXT NOT NULL, source_release TEXT NOT NULL, source_file TEXT NOT NULL,
        model TEXT NOT NULL, grid_signature TEXT NOT NULL,
        analysis_init TIMESTAMP NOT NULL, analysis_lead_h INTEGER NOT NULL CHECK (analysis_lead_h >= 0),
        accumulation_init TIMESTAMP NOT NULL, accumulation_lead_h INTEGER NOT NULL CHECK (accumulation_lead_h >= 0),
        analysis_url TEXT NOT NULL, accumulation_url TEXT NOT NULL,
        analysis_etag TEXT, accumulation_etag TEXT,
        analysis_fields_json JSON NOT NULL, accumulation_fields_json JSON NOT NULL,
        analysis_ranges_json JSON NOT NULL, accumulation_ranges_json JSON NOT NULL,
        county_index_version TEXT NOT NULL, receipt_path TEXT NOT NULL,
        retrieved_at TIMESTAMP NOT NULL, fallback_kind TEXT, loaded_at TIMESTAMP NOT NULL,
        PRIMARY KEY (scenario_id, valid_ts))""",
