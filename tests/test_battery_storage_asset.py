...
from scripts.render_battery_storage_preview import SIZE, render
from scripts.validate_battery_storage_asset import CATALOG_PATH, META_PATH, validate
...
def test_preview_renderer_creates_contract_png(tmp_path: Path):
    preview = tmp_path / "battery_storage.preview.png"
    render(preview)
