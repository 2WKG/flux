...
The labeled proof sheet is `../../renders/flux_symbol_proof.png` and its SVG counterpart. It shows 32px and 24px symbols on dark graphite at actual display size.
