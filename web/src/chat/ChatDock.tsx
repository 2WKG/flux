      ...
      <div className="flux-chat-context" aria-label="Scene context">
        ...
        {editing ? (
          <div className="flux-chat-fields">
            ...
            <label htmlFor={`${id}-selected_physical_asset_id`}>Selected physical asset<input id={`${id}-selected_physical_asset_id`} name="selected_physical_asset_id" maxLength={256} value={draft.selected_physical_asset_id ?? ""} onChange={(event) => update({ selected_physical_asset_id: event.target.value || null })} placeholder="No source asset selected" /></label>
