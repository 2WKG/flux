...
def write_report(
    ...
    # newline="\n" so the artifacts are written LF on every platform. Without it
    # Path.write_text applies os.linesep on Windows, and the regenerated bytes stop
    # matching the LF-canonical files these digests are pinned against.
    json_out.write_text(
