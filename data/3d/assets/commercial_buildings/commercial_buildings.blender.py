...
``commercial_buildings.meta.json`` declares. That identity, the derived bounds, and the
connector positions are asserted by ``tests/test_commercial_buildings_kit.py`` and
``scripts/validate_commercial_buildings_kit.py`` without Blender installed.
...
SCENE_NODES: tuple[dict[str, object], ...] = (
    {
        "name": "office_block",
        "primitive": "box",
        "position_m": (0.0, 16.0, -15.0),
        "half_extents_m": (28.0, 16.0, 34.0),
    },
    {
        "name": "storefront_west",
        "primitive": "box",
        "position_m": (-35.0, 6.0, 30.0),
        "half_extents_m": (14.0, 6.0, 20.0),
    },
    {
        "name": "storefront_east",
        "primitive": "box",
        "position_m": (35.0, 6.0, 30.0),
        "half_extents_m": (14.0, 6.0, 20.0),
    },
    {
        "name": "business_annex",
        "primitive": "box",
        "position_m": (0.0, 4.0, 42.0),
        "half_extents_m": (18.0, 4.0, 12.0),
    },
)
...
CONNECTORS: tuple[dict[str, object], ...] = (
    {"name": "CONN_MV_FEED_0", "position_m": (0.0, 0.0, 50.0)},
)
